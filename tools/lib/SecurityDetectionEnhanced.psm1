...
function Test-CryptographicFailure {
  <#
    .SYNOPSIS
...
function Test-InjectionVulnerability {
  <#
    .SYNOPSIS
...
function Test-IntegrityFailure {
  <#
    .SYNOPSIS
