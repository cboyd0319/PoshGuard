...
function Test-EnhancedSecurityIssues {
    <#
    .SYNOPSIS
...
function Find-MITREATTCKPatterns {
    <#
    .SYNOPSIS
        Detect MITRE ATT&CK techniques
    #>
...
function Find-CodeInjectionVulnerabilities {
    <#
    .SYNOPSIS
...
function Find-CryptographicWeaknesses {
    <#
    .SYNOPSIS
...
function Find-PathTraversalVulnerabilities {
    <#
    .SYNOPSIS
